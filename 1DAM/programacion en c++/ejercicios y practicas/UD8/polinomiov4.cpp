...
int main(){
    ...
    cout << " ----------------sumav3---------------------" <<endl;
    cout << " sumando con el operador + " << endl;
    Polinomio res3 = p1 + p2;
    res3.imprimir();

    cout << " ----------------imprimiendo con el operador << ---------------------" <<endl;
    //al sobrecar el << podemos imprimirlo de esta forma
    cout << res3;


    /*cout << " ----------------sumav4---------------------" <<endl;
    Polinomio *res2 = a1->sumarv4(a2);
   
    cout <<"sumado fuera del v4"<<endl;
    res2->imprimir();*/
